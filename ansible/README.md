...
1. Install Ansible 2.1.1.0: `brew install ansible`
2. Install PyYAML: `pip install yaml`
3. Read this document.
4. Clone the node secrets repository (if you don't have access ask anyone
   in the [build group][1]).
5. Copy the private keys (check the secrets repo for instructions) to your
